...
(function() {
  var add_btn, browse_btn, collect_item, delete_btn, escapeChars, img_settings, mask, settings_btn, tag_input, title_input, updatePanel, update_btn, update_icon, url_input;
  ...
  update_btn.click(function() {
    ...
    return update(collect_item(), function(result) {
      updatePanel(result);
      mask.fadeOut();
